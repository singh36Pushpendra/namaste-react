...
const RestaurantCard = (props) => {
  ...
  return (
    ...
    >
      <img className="res-logo" src={resData.imageUrl} alt="res-logo" />
      <h3>{resData.name}</h3>
      <h4>{resData.subtitleData.cuisines[0].name}</h4>
      <h4>4.4 stars</h4>
      <h4>38 minutes</h4>
    </div>
  );
...
const resData = {
  ...
  url: "https://www.zomato.com/bangalore/phobidden-fruit-indiranagar?zrp_bid=0&zrp_pid=14",
  imageUrl:
    "https://b.zmtcdn.com/data/pictures/chains/0/51600/4838f231377a34f05bc7147abf46f20f.jpg",
  subtitleData: {
    cuisines: [
      {
        deeplink:
  ...
  rating_new: {
    ...
    ratings: {
      DINING: {
        ...
        rating: "4.4",
        reviewCount: "3,283",
        reviewTextSmall: "3,283 Reviews",
        subtext: "3,283 Dining Reviews",
        color: "#1C1C1C",
        ratingV2: "4.4",
        subtitle: "DINING",
